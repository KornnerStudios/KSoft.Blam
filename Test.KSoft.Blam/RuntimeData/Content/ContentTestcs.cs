...
namespace KSoft.Blam.RuntimeData.Test
{
	...
	public class ContentTest : BaseTestClass
	{
		...
		public void ContentMiniMetadataEncodingTest()
		{
			...
			[
				new(Engine.EngineRegistry.EngineBranchHalo4, "gfyccqramf3545555m2exv3nst10wqyfqaeaaaaaa"), // oddball
				new(Engine.EngineRegistry.EngineBranchHalo4, "gfyccaja0fz545555imwszqgtcysgxrmv12ihzebo"), // ctf
			];
