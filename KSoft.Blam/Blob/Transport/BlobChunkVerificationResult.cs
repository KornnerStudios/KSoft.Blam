...
namespace KSoft.Blam.Blob.Transport
{
	...
	public enum BlobChunkVerificationResult : short
	{
		...
		/// <remarks><see cref="BlobChunkVerificationResultInfo.Data"/> is zero</remarks>
		Valid,
		/// <summary>The chunk was invalid in a non-uniform way</summary>
		/// <remarks><see cref="BlobChunkVerificationResultInfo.Data"/> may contain the invalid value</remarks>
		Invalid,

		#region Stream
		/// <summary>Not enough space in the BLF stream to perform the next stream operation</summary>
		/// <remarks><see cref="BlobChunkVerificationResultInfo.DataAsLength"/> will contain the amount of bytes left (long truncated to uint)</remarks>
		EndOfStream,
		...
		/// <remarks><see cref="BlobChunkVerificationResultInfo.DataAsLength"/> will contain the stream length (long truncated to uint)</remarks>
		StreamTooSmall,
		...
		/// <remarks><see cref="BlobChunkVerificationResultInfo.DataAsSignature"/> will contain the invalid value</remarks>
		InvalidSignature,
		/// <summary>The chunk's total size did not match the expected value</summary>
		/// <remarks><see cref="BlobChunkVerificationResultInfo.DataAsSize"/> will contain the invalid value</remarks>
		InvalidSize,
		/// <summary>The chunk's version field did not match any expected values</summary>
		/// <remarks><see cref="BlobChunkVerificationResultInfo.DataAsVersion"/> will contain the invalid value</remarks>
		InvalidVersion,
		#endregion
		#region Header
		/// <summary>The BLF header's endian signature was an unexpected value</summary>
		/// <remarks><see cref="BlobChunkVerificationResultInfo.Data"/> will contain the invalid value</remarks>
		InvalidEndian,
		#endregion
		#region Footer
		/// <summary>The BLF footer's blob size didn't match what we've actually streamed</summary>
		/// <remarks><see cref="BlobChunkVerificationResultInfo.DataAsLength"/> will contain the invalid value</remarks>
		InvalidBlobSize,
		/// <summary>The BLF footer's authentication was an unexpected value</summary>
		/// <remarks><see cref="BlobChunkVerificationResultInfo.DataAsAuthentication"/> will contain the invalid value</remarks>
